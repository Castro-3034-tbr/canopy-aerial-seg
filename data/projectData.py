...
class ProjectData:
    ...
    def __init__(self):
        ...
        self.readerThreadRunning = False        # Variable para controlar el estado del hilo de lectura
        self.processorThreadRunning = False     # Variable para controlar el estado del hilo de procesamiento
